...
BOOL CSystemTray::SetSmallIcon(UINT nIDResource)
{
    HICON hIcon = (HICON) ::LoadImage(AfxGetResourceHandle(),MAKEINTRESOURCE(nIDResource),IMAGE_ICON,16,16,LR_DEFAULTCOLOR);
